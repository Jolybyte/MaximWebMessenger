# app.py - версия с REST API вместо Admin SDK
    ...
    def get_messages(limit=100):
        ...
        try:
            ...
            if messages:
                ...
                return [msg[1] for msg in sorted_messages[-limit:]]
            return []
        except Exception as e:
...
if __name__ == '__main__':
    ...
    if test is not None:
        ...
        print("Warning: Firebase connection failed. Check your database URL.")
